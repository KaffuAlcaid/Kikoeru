    ...
    <div v-if="!thumbnailMode">
      ...
      <div v-show="metadata.title" class="row items-center">
        ...
        <div class="col-auto">
          ...
          <a v-if="!dlsiteCode.startsWith('CC')" class="text-blue" :href="`https://www.dlsite.com/home/work/=/product_id/${dlsiteCode}.html`" rel="noreferrer noopener" target="_blank">DLsite</a>
        </div>
      </div>
